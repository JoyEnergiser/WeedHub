...
export class ProductsService {
  afs: AngularFirestoreCollection<Product>;
  productFB: Observable<Product[]>;
  ...
  // Initialize 
  constructor(private http: Http,private toastrService: ToastrService, private firestore: AngularFirestore) { 
     this.compareProducts.subscribe(products => products = products);
     this.afs = this.firestore.collection<Product>('Product'),
        this.productFB = this.afs.valueChanges()
  }
